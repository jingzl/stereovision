...
if __name__ == '__main__':
    # 读取MiddleBurry数据集的图片
    iml = cv2.imread('../data/MiddleBurry/Adirondack-perfect/im0.png')  # 左图im0
    imr = cv2.imread('../data/MiddleBurry/Adirondack-perfect/im1.png')  # 右图im1
    ...
    cv2.imwrite('../data/check.png', line)
